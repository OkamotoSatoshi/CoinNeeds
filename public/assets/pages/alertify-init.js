...
(function() {
    ...
    for(let i=0;i<noticeList.length;i++) {
        noticeList[i].addEventListener('click', function() {
            var text = noticeList[i].getAttribute("notice");
            alertify.error(text);
        })
    }
    ...
    //         alertify.error("Upcoming, please follow the news on twitter");
    //     })
    // }
